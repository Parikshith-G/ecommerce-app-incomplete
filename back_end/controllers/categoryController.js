...
const newCategory=async(req,res,next)=>{
    ...
    try{
        ...
        if(!category)
        {
            res.status(400).send("Categots imput is empty");
        }
...
const saveAttribute = async (req, res, next) => {
    ...
    try {
        ...
        if(categoryExists && categoryExists.attrs.length > 0) {
...
module.exports={getCategory,newCategory,deleteCategory,saveAttribute};
